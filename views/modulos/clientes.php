      ...
      <div class="box-body">        
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">         
        ...
        <?php
          ...
          $clientes = ControladorClientes::ctrListarCliente($item, $valor);
          ...
          foreach ($clientes as $key => $value) {
            ...
            echo '<tr>
                    ...
                    <td>'.$tipoUsuario.'</td>';
                    if ($value["estado"] != 0) {
                      echo '<td><button class="btn btn-success btn-xs btnActivarCliente" idUsuario="' . $value["idUsuario"] . '" estado="0">Activado</button></td>';
                    } else {
                      echo '<td><button class="btn btn-danger btn-xs btnActivarCliente" idUsuario="' . $value["idUsuario"] . '" estado="1">Desactivado</button></td>';
                    }

              echo '<td>
                      <div class="btn-group">
                        <button class="btn btn-warning btnEditarCliente" data-toggle="modal" data-target="#modalEditarTercero" idUsuario="'.$value["idUsuario"].'" estado="'.$value["estado"].'"><i class="fa fa-pencil"></i></button>';
