<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administración de créditos</li>
    </ol>
  </section>
  ...
  <section class="content">
    <div class="box">
      <div class="box-header with-border">
        <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarCredito">
          Agregar créditos
        </button>
      </div>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Editar créditos</h4>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="editarClienteCre" readonly required>

                  <option id="editarClienteCre"></option>                 
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control input-lg" id="editarCredito" name="editarCredito" step="any" min="0" placeholder="Valor del crédito" required>

                  <input type="hidden"  name="idCredito" id="idCredito" required>
              ...
              <div class="col-xs-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control input-lg" id="editarDiasPlazo" name="editarDiasPlazo" step="any" min="0" placeholder="Días máx. plazo" required>
